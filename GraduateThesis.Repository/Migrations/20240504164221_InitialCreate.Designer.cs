...
namespace GraduateThesis.Repository.Migrations
{
    ...
    [Migration("20240504164221_InitialCreate")]
            ...
            modelBuilder.Entity("GraduateThesis.Core.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5371)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Spor",
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5383)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Kitap",
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5385)
                        },
                        new
                        {
                            Id = 4,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryName = "Dans",
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5386)
                        },
                        new
                        {
                            Id = 6,
            ...
            modelBuilder.Entity("GraduateThesis.Core.Models.Club", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5610),
                            IsClubActive = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5612),
                            IsClubActive = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5613),
                            IsClubActive = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5614),
                            IsClubActive = true
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 4, 19, 42, 21, 532, DateTimeKind.Local).AddTicks(5615),
                            IsClubActive = true
                        });
                });
