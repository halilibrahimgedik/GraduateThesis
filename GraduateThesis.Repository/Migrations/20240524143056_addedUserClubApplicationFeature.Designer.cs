...
namespace GraduateThesis.Repository.Migrations
{
    ...
    [Migration("20240524143056_addedUserClubApplicationFeature")]
    partial class addedUserClubApplicationFeature
    {
            ...
            modelBuilder.Entity("GraduateThesis.Core.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "72f16fb4-7c7b-4a8f-9c11-d348f617ef4f",
                            Email = "halilgedik4234@gmail.com",
                            EmailConfirmed = true,
                            FullName = "Halil ibrahim gedik",
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b08269cd-ea6a-48c2-817d-d43f10971cde",
            ...
            modelBuilder.Entity("GraduateThesis.Core.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2317),
                            Name = "Teknoloji"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2325),
                            Name = "Spor"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2326),
                            Name = "Kitap"
                        },
                        new
                        {
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2327),
                            Name = "Dans"
                        },
                        new
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2328),
                            Name = "Girişimcilik"
                        });
                });
            ...
            modelBuilder.Entity("GraduateThesis.Core.Models.Club", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2614),
                            IsActive = true,
                            Name = "DU Siber",
                        ...
                        new
                        {
                            Id = 2,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2616),
                            IsActive = true,
                            Name = "Kitap Dostu",
                        ...
                        new
                        {
                            Id = 3,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2617),
                            IsActive = true,
                            Name = "DU Archer Club",
                        ...
                        new
                        {
                            Id = 4,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2619),
                            IsActive = true,
                            Name = "DU Scout Club",
                        ...
                        new
                        {
                            Id = 5,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2620),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 6,
                            ClubUniversityId = 60,
                            CreatedDate = new DateTime(2024, 5, 24, 17, 30, 56, 373, DateTimeKind.Local).AddTicks(2621),
                            IsActive = true,
