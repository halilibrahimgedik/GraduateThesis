...
namespace GraduateThesis.Repository.Seeds
{
    public class ClubSeed : IEntityTypeConfiguration<Club>
    {
        ...
        {
            builder.HasData(
                    new Club() { Id = 1, Name = "DU Siber", Summary = "DU Siber Kulübü, öğrencilere teknoloji, yazılım ve siber güvenlik alanlarında deneyim kazanma imkanı sunar. Atölyeler, yarışmalar ve seminerlerle öğrenme ortamı sağlar. Katılın, teknolojiye adım atın ve kendinizi geliştirin!", ClubUniversityId = 60, Url = "default.jpg", IsActive = true, CreatedDate = DateTime.Now },

                    new Club() { Id = 2, Name = "Kitap Dostu", Summary = "Kitap Dostu Kulübü, kitap tutkunlarını bir araya getirerek edebiyatın büyülü dünyasında yolculuğa çıkarır. Okuma tutkusunu paylaşan herkesi bekliyoruz!", ClubUniversityId = 60, Url = "default.jpg", IsActive = true, CreatedDate = DateTime.Now },

                    new Club() { Id = 3, Name = "DU Archer Club", Summary = "DU Archer Club, okçuluk tutkunlarının buluşma noktasıdır. Okçuluk sporuna ilgi duyan herkesi bekliyoruz! ", ClubUniversityId = 60, Url = "default.jpg", IsActive = true, CreatedDate = DateTime.Now },

                    new Club() { Id = 4, Name = "DU Scout Club", Summary = "Kulübümüz, doğayla iç içe olmayı, macera dolu anlar yaşamayı seven herkesi bir araya getiriyor. Keşfetmeye hazır mısın?", ClubUniversityId = 60, Url = "default.jpg", IsActive = true, CreatedDate = DateTime.Now },
